...
@interface FSPSAppDelegate()

@property (nonatomic, retain) NSString *gameId;
@property (nonatomic, strong) GuesstimatePushHandler *pushHandler;

@end

@implementation FSPSAppDelegate
...
-(BOOL)application:(UIApplication *)application willFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    [Parse setApplicationId:GUESSTIMATE_PARSE_APP_ID
                  clientKey:GUESSTIMATE_PARSE_CLIENT_KEY];
    ...
    GuesstimateContactsMenuController *leftDrawer = [[GuesstimateContactsMenuController alloc] init];
    GuesstimateAlertsMenuController *rightDrawer = [[GuesstimateAlertsMenuController alloc] init];
    
    [navigationController setRestorationIdentifier:@"GuesstimateCenterNavigationControllerRestorationKey"];
    ...
    [drawerController setRestorationIdentifier:@"Guesstimate"];
    [drawerController setMaximumLeftDrawerWidth:275.0];
    [drawerController setMaximumRightDrawerWidth:275.0];
...
- (void)applicationDidBecomeActive:(UIApplication *)application
{
    ...
    if(authUser != nil) {
        if(self.gameId != nil) {
            ...
            [navigationController pushViewController:drawerController animated:YES];
            return;
        }
    }
    
    // Last resort, load the welcome controller
    GuesstimateWelcomeViewController *viewController = [[GuesstimateWelcomeViewController alloc] init];
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"guesstimate" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"guesstimate.sqlite"];
